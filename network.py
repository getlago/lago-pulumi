...
class Vpc(ComponentResource):
  ...
  def __init__(self,
    ...
    for zone in zone_names:
      vpc_subnet = ec2.Subnet(f'{subnet_base_name}-{zone}',
    ...
    self.redis_security_group = ec2.SecurityGroup(redis_sg_name,
      vpc_id=self.vpc.id,
      description='Allow client access.',
      tags={
        'Name': redis_sg_name,
    ...
    self.app_security_group = ec2.SecurityGroup(app_sg_name,
      vpc_id=self.vpc.id,
